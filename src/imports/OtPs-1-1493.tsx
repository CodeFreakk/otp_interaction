...
export default function OtPs() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative size-full" data-name="OTPs">
      <Password1 />
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#239954] text-[14px] tracking-[0.1px]" style={{ fontFeatureSettings: "'ss11', 'calt' 0, 'liga' 0" }}>
